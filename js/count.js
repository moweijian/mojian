...
if (location.hash!="#nocount"){
	if(jsPath.indexOf(window.location.host) >= 0)
	{
		...
		countbyajax.open("GET",jsPath+"count.php?get="+location.pathname+location.search+"&referrer="+referrer+"&os="+navigator.platform+"&lang="+navigator.language+"&browser="+browser+"&ua="+navigator.userAgent,true);
		countbyajax.send();
	}
	else
	{
		...
		JSONP.src=jsPath+"count.php?get="+location.pathname+location.search+"&referrer="+referrer+"&os="+navigator.platform+"&lang="+navigator.language+"&browser="+browser+"&ua="+navigator.userAgent;
